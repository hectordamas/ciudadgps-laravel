    ...
    public function categoriaSlug($slug, Request $request){
        try {
            ...
            if($category){
                ...
                $mergedString = $tagsString . ', ' . $namesString . ', ' . $category->name . ', ' . $category->name . ' cerca, ' . $category->name . ' cerca de mi, ' . $category->name . ' cerca, reservar, comida rapida, '  . $category->name . ' en Venezuela, ' . $category->name . ' en Caracas, ' . $category->name . ' cerca, ' . $category->name . ' en infoguia, ' . $category->name . ' a domicilio, ' . $category->name . ' en CiudadGPS';
