                ...
                <div class="product_share">
                    ...
                    <ul class="social_icons">
                        <?php if($commerce->facebook): ?>
                            <li><a href="<?php echo e($commerce->facebook); ?>" target="blank"><i class="fab fa-facebook-f"></i></a></li>
                        <?php endif; ?>

                        <?php if($commerce->instagram): ?>
                            <li><a href="<?php echo e($commerce->instagram); ?>" target="blank"><i class="fab fa-instagram"></i></a></li>
                        <?php endif; ?>

                        <?php if($commerce->twitter): ?>
                            <li><a href="<?php echo e($commerce->twitter); ?>" target="blank"><i class="fab fa-twitter"></i></a></li>
                        <?php endif; ?>

                        <?php if($commerce->tiktok): ?>
                            <li><a href="<?php echo e($commerce->tiktok); ?>" target="blank"><i class="fab fa-tiktok"></i></a></li>
                        <?php endif; ?>

                        <?php if($commerce->whatsapp): ?>
                            <li><a href="https://api.whatsapp.com/send/?phone=<?php echo e(str_replace('+', '', $commerce->whatsapp)); ?>" target="blank"><i class="fab fa-whatsapp"></i></a></li>
                        <?php endif; ?>

                        <?php if($commerce->user_email): ?>
                            <li><a href="mailto:<?php echo e($commerce->user_email); ?>" target="blank"><i class="far fa-envelope"></i></a></li>
                        <?php endif; ?>

                        <?php if($commerce->telephone): ?>
                            <li><a href="tel:<?php echo e($commerce->telephone); ?>" target="blank"><i class="fas fa-phone"></i></a></li>
                        <?php endif; ?>

                        <?php if($commerce->web): ?>
                            <li><a href="<?php echo e($commerce->web); ?>" target="blank"><i class="fab fa-chrome"></i></a></li>
                        <?php endif; ?>
                    </ul>
                                        ...
                                        <li>
                                            ...
                                            <div class="comment_block">
                                                ...
                                                <p class="customer_meta">
                                                    ...
                                                    <span class="comment-date"><?php echo e(date_format($comment->created_at, 'd M Y')); ?></span>
                                                </p>
        ...
        <div class="row">
        	...
        	<div class="col-12">
            	<div class="releted_product_slider carousel_slider owl-carousel owl-theme" data-margin="2" data-responsive='{"0":{"items": "2"}, "481":{"items": "3"}, "768":{"items": "4"}, "1199":{"items": "5"}}'>
                	<?php $__currentLoopData = $commerce->products->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="item">
                        <div class="product shadow product_box border-0">
                            <div class="product_img" style="aspect-ratio: 1;">
                                <a href="#" style="position: relative; height: 100%;">
                                    <img 
                            ...
                            <div class="product_info">
                                <h6 class="product_title"><a href="#"><?php echo e($product->name); ?></a></h6>
                                <div class="product_price">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\ciudadgps\resources\views/public/commerces/show.blade.php ENDPATH**/ ?>