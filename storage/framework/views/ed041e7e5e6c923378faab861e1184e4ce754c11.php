...
<title>Resultados para <?php echo e($tag->name); ?> en CiudadGPS</title>
	...
	<div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h6>Resultados para: <?php echo e($tag->name); ?></h6>
                    </div>
                </div>
...
<!-- END SECTION ABOUT --> 
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos en Curso\ciudadgps\ciudadgps laravel\resources\views/public/articles/tags.blade.php ENDPATH**/ ?>