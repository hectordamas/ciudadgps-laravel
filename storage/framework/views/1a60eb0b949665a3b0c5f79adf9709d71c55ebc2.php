...
<title>CiudadGPS - Somos la App que te conecta. Establecimientos comerciales en Venezuela</title>
                    	...
                    	<div class="row justify-content-center">
                            <div class="col-lg-10 col-md-10">
                                <div class="banner_content text_white text-left">
                                    <h3 class="staggered-animation" data-animation="fadeInDown" data-animation-delay="0.3s">Descubre locales comerciales en todo el país</h3>
                ...
                <div class="banner_slide_content banner_content_inner">
                	<div class="container">
                    	<div class="row justify-content-center">
                            <div class="col-lg-10 col-md-10">
                                <div class="banner_content text_white text-left">
                                    <h4 class="staggered-animation" data-animation="fadeInDown" data-animation-delay="0.3s">Descubre locales comerciales en todo el país</h4>
                                    <p class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.4s">Accede a un amplio directorio de información sobre los negocios establecidos en Venezuela.</p>
                                    <div style="max-width:450px;">
                                        <form action="<?php echo e(url('/comercios')); ?>" class="d-flex">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="search" placeholder="Cuéntanos. ¿Qué Estás Buscando?" class="pl-0 form-control border-0 bg-light">
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
</html><?php /**PATH I:\ciudadgps\resources\views/welcome.blade.php ENDPATH**/ ?>