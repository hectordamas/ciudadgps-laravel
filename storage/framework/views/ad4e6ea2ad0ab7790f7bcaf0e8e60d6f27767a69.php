                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-12 my-2">
                                <a href="/comercios/<?php echo e($product->commerce->id); ?>" class="btn btn-dark btn-sm">Ver Comercio</a>
                                <a href="/catalogo-de-productos/<?php echo e($product->commerce->id); ?>"  class="btn btn-dark btn-sm mr-2">Ver Catálogo</a>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos en Curso\ciudadgps\ciudadgps laravel\resources\views/public/products/show.blade.php ENDPATH**/ ?>