...
<title> <?php if(isset($category)): ?> <?php echo e($category->name); ?> en CiudadGPS  <?php else: ?> Buscar en CiudadGPS, Conectamos con tu necesidad. Establecimientos y locales comerciales en Venezuela <?php endif; ?></title>
        ...
        <div class="row align-items-center">
        	<div class="col-md-8">
                <div class="page-title">
            		<h4 class="text-light text-capitalize">Resultados de búsqueda</h4>
                </div>
            </div>
            <div class="col-md-4">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-lg-9">
            <?php
                ...
                $actualOrder = $orderTypes->where('name', $order)->first();
            ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\ciudadgps\resources\views/public/commerces/index.blade.php ENDPATH**/ ?>