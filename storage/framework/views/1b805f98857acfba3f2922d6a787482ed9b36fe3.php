...
<title> 
    <?php if(isset($category)): ?><?php echo e($category->name); ?> en CiudadGPS <?php else: ?> 
        <?php if(isset($search)): ?><?php echo e($search); ?> en CiudadGPS <?php else: ?> Buscar en CiudadGPS <?php endif; ?>
    <?php endif; ?>
</title>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-9">
                ...
                <div class="row align-items-center mb-4 pb-1">
                    <form id="formOrder" action="<?php echo e(url('/comercios/slug-categorias/'. $category->slug)); ?>" method="get" class="col-12">
                    ...
                    <div class="col-lg-12">
                        <div class="product">
                            ...
                            <div class="product_info">
                                <h6 class="product_title"><a href="/slug-comercios/<?php echo e($c->slug); ?>"><?php echo e($c->name); ?></a></h6>
                                ...
                                <div class="pr_desc">
                                    <p style="text-align: justify;"><?php echo $resumen; ?> <a href="/slug-comercios/<?php echo e($c->slug); ?>">Leer Más</a> </p>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Proyectos en Curso\ciudadgps\ciudadgps laravel\resources\views/public/commerces/index.blade.php ENDPATH**/ ?>