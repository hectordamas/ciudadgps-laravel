            ...
            <div class="card-body">
                ...
                <form action="/commerces/<?php echo e($commerce->id); ?>/update" method="post" class="row" id="editCommerce" enctype="multipart/form-data">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <input type="text" class="form-control" name="user_name" id="user_name" value="<?php echo e($commerce->user_name); ?>">
                    </div>
                    <div class="col-md-3 form-group">
                        <label for="user_lastname" class="text-dark font-weight-bold">Apellido:</label>
                        <input type="text" class="form-control" name="user_lastname" id="user_lastname" value="<?php echo e($commerce->user_lastname); ?>">
                    </div>
                    <div class="col-md-3 form-group">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <textarea name="excerpt" class="form-control" rows="3"><?php echo e($commerce->excerpt); ?></textarea>
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <textarea name="info" id="info" class="form-control"><?php echo $commerce->info; ?></textarea>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/ciudadgps.com/resources/views/commerces/edit.blade.php ENDPATH**/ ?>