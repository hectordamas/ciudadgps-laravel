...
<title><?php echo e($job->title); ?> - CiudadGPS - Empleos</title>
                    ...
                    <div class="card shadow border-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <a href="/empleo/<?php echo e($job->slug); ?>" class="col-md-2 d-flex justify-content-center">
                                    <img src="<?php echo e($job->commerce->logo); ?>" style="width: 100px; height: 100px;" class="rounded-circle border" alt="<?php echo e($job->title); ?>" />
                                </a>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Proyectos en Curso\ciudadgps\ciudadgps laravel\resources\views/public/jobs/show.blade.php ENDPATH**/ ?>