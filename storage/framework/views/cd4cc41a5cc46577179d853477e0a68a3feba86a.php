            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('commerces.store')); ?>" method="post" class="row" id="storeCommerce" enctype="multipart/form-data">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <input type="text" class="form-control" required name="user_lastname" id="user_lastname">
                    </div>
                    <div class="col-md-3 form-group">
                    ...
                    <div class="col-md-3 form-group">
                        <label for="youtube" class="text-dark font-weight-bold">ID de Youtube:</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label for="hide" style="font-size:13px;" class="text-dark font-weight-bold">
                                    <input type="checkbox" name="hide" id="hide" value="Sí" class="mr-2"> Ocultar
                                </label>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyectos en Curso\ciudadgps\ciudadgps laravel\resources\views/commerces/create.blade.php ENDPATH**/ ?>