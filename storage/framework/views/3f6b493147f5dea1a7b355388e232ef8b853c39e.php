        ...
        <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <?php
                            $commerces = App\Models\Commerce::whereNotNull('paid');
                            $comerciosPorMes = $commerces->whereMonth('created_at', '=', date('m'))->whereYear('created_at', '=', date('Y')); 
                            $totalPorMes = $comerciosPorMes->count() * 45;
                        ?>
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                            Ingresos (Mes actual)</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">$<?php echo e(number_format($totalPorMes, 2, '.', ',')); ?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row no-gutters align-items-center">
                    ...
                    ?>
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                            Ingresos (Año)</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">$<?php echo e(number_format($totalPorAño, 2, '.', ',')); ?></div>
                    </div>
                    <div class="col-auto">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/ciudadgps.com/resources/views/home.blade.php ENDPATH**/ ?>