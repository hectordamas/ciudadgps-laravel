                ...
                <li class="mega-menu-col col-lg-3">
                    <ul>
                        <?php $__currentLoopData = $catHeader->skip($section)->take(12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $url = '/comercios/categorias/' . $cat->id . '?order=id';
                                if(session()->has('latitude') && session()->has('longitude')){
                                    $url = '/comercios/categorias/' . $cat->id . '?order=distance';
                                }
                            ?>
...
</li><?php /**PATH C:\Users\hdamas\Desktop\ciudadgps laravel\resources\views/layouts/megaMenu.blade.php ENDPATH**/ ?>