        ...
        <div class="row align-items-center">
        	<div class="col-md-8">
                <div class="page-title">
            		<h4 class="text-light text-capitalize">Todas las Categorías</h4>
                </div>
            </div>
            <div class="col-md-4">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/ciudadgps.com/resources/views/public/categories/index.blade.php ENDPATH**/ ?>