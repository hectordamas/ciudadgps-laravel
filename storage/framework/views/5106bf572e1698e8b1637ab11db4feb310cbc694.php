...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('banners.store')); ?>" method="post" class="row" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/ciudadgps.com/resources/views/banners/create.blade.php ENDPATH**/ ?>