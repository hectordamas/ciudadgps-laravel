        ...
        <div class="row align-items-center">
        	<div class="col-md-8">
                <div class="page-title">
            		<h3 class="text-light text-capitalize">Inicia Sesión</h3>
                </div>
            </div>
            <div class="col-md-4">
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/ciudadgps.com/resources/views/auth/login.blade.php ENDPATH**/ ?>