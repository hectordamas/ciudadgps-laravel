                    ...
                    <div class="card shadow border-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <a href="/jobs/<?php echo e($job->id); ?>" class="col-md-2 col-3 d-flex justify-content-center">
                                    <img src="<?php echo e($job->commerce->logo); ?>" style="width: 100px; height: 100px;" class="rounded-circle border d-none d-md-block" alt="" srcset="">
                                    <img src="<?php echo e($job->commerce->logo); ?>" style="width: 50px; height: 50px;" class="rounded-circle border d-block d-md-none" alt="" srcset="">
                                </a>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/ciudadgps.com/resources/views/public/jobs/index.blade.php ENDPATH**/ ?>