            ...
            <li class="nav-item">
                ...
                <div id="collapseArticle" class="collapse" aria-labelledby="headingArticle" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo e(url('articles/create')); ?>">Crear Artículos</a>
                        <a class="collapse-item" href="<?php echo e(url('articles/index')); ?>">Lista de Artículos</a>
                    </div>
                </div>
            </li>
...
<?php /**PATH E:\Proyectos en Curso\ciudadgps\ciudadgps laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>