        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('commerces.store')); ?>" method="post" class="row" id="storeCommerce" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 form-group">
                        <input type="hidden" name="lat" id="lat" value="10.479931">
                        <input type="hidden" name="lon" id="lng" value="-66.8201208">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\ciudadgps\resources\views/commerces/create.blade.php ENDPATH**/ ?>