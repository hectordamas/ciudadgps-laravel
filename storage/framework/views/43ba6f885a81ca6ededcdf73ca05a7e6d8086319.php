...
unset($__errorArgs, $__bag); ?>
                    ...
                    <ul class="btn-login list_none text-center">
                        ...
                        <li><a href="<?php echo e(url('auth/google')); ?>" class="btn btn-dark"><i class="ion-social-apple"></i>Apple ID</a></li>
                    </ul>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\ciudadgps\resources\views/auth/register.blade.php ENDPATH**/ ?>