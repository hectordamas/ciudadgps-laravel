...
@section('title')
<title>Resultados para {{$tag->name}} en CiudadGPS</title>
<meta name="description" content="Página de Etiquetas: Blog, articulos y noticias de CiudadGPS: tocamos temas de empleo, e-commerce, directorios de comercios, entre otras cosas" />
<meta name="keywords" content="Etiquetas, Afiliar, comercio, negocio, emprendimiento, bolsa de empleo, talento, personal, captacion, trabajo, venezuela, comercio electrónico, viajes, trabajo, medicina, aplicación">
@endsection
@section('content')
	...
	<div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h6>Resultados para: {{$tag->name}}</h6>
                    </div>
                </div>
